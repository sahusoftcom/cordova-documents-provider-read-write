...
import com.sahusoft.nativeDirectory.adapters.DirectoryAdapter;
import com.sahusoft.nativeDirectory.data.Category;
import com.sahusoft.nativeDirectory.utils.Utils;
import com.sahusoft.nativeDirectory.Constants;
import com.sahusoft.nativeDirectory.FileInfo;
import com.sahusoft.nativeDirectory.adapters.FileArrayAdapter;
import com.sahusoft.mobile.ionic.version1.R;
...
public class FileChooserActivity extends ListActivity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        selectFolderBtn = (Button)mDrawerLayout.findViewById(R.id.select_button);
        selectFolderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fileSelected = new File(currentFolder.getPath());
                Intent intent = new Intent();
                intent.putExtra(Constants.KEY_FILE_SELECTED,
                        fileSelected.getAbsolutePath());
                Uri uri = Uri.fromFile(new File(fileSelected.toString()));
                intent.setData(uri);
                    ...
                    mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener()
                    {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1,
                            ...
                            if(cat.canWrite) {
                                ...
                                }).setMessage(cat.title + " storage is write protected!").show();
                            }
...
*/
    ...
    private void fill(File f) {
        ...
        if(f.getAbsolutePath().trim().equalsIgnoreCase(currentCategory.path.trim()) == true)
        {
            ...
            selectFolderBtn.setText("Select "+currentCategory.title);
        }
        else
        {
            this.setTitle(currentCategory.title + ": " + f.getName());
            selectFolderBtn.setText("Select "+f.getName());
        }
